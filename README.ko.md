...
자세한 조사 기록은 [`docs/research.ko.md`](docs/research.ko.md)에 있습니다.

BFT 컨센서스 구현·실험 로드맵은 [`docs/bft-consensus-roadmap.ko.md`](docs/bft-consensus-roadmap.ko.md)에 있습니다.

파일, 타입, 테스트명, 완료조건까지 내려간 구체적 마일스톤은 [`docs/milestones.ko.md`](docs/milestones.ko.md)에 있습니다.
